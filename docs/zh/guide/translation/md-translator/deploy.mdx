...
head:
  - - meta
    - property: og:title
      content: Markdown 翻译工具部署指南 - Vercel 与本地部署 | Tools By AI
description: 需要私有化部署 Markdown 翻译工具？本指南为您提供详细的本地部署和 Vercel 一键部署说明，帮助您快速搭建专属的文档翻译环境。
---
...
[![Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Frockbenben%2Fmd-translator%2Ftree%2Fmain)
