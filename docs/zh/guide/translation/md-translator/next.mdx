...
head:
  - - meta
    - property: og:title
      content: MD Translator 开发背景与目录翻译 | Tools By AI
description: 想知道 MD Translator 的开发初衷吗？本页对比了 GT4T、Markdown Docs Translator 等工具的优劣，并介绍了我们的解决方案，同时提供了目录翻译功能的实现说明。
---
