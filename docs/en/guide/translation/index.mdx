...
description: A free translation suite for developers and creators, covering subtitle, Markdown, and JSON i18n files. Supports 26 LLM endpoints and 9 translation APIs across 120+ languages.
---
...
- **Wide API choice**: 9 translation APIs + 26 LLM endpoints covering free, commercial, and self-hosted use cases ([compare them here](./api))
...
- **Command line too**: `yarn cli` runs the exact same pipeline as the web app across subtitles, Markdown and JSON ([CLI guide](./cli))
