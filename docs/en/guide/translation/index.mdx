...
description: A free translation suite for developers and creators, covering subtitle, Markdown, and JSON i18n files. Supports 21 LLMs and 8 translation APIs across 100+ languages.
---
...
- **100+ languages** with one-pass multi-language output: translate one English subtitle into Chinese, Japanese, German, and French at once
