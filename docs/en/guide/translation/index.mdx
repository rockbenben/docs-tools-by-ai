...
description: A free translation suite for developers and creators, covering subtitle, Markdown, and JSON i18n files. Supports 23 LLMs and 7 translation APIs across 120+ languages.
---
...
- **Wide API choice**: 7 translation APIs + 23 LLMs covering free, commercial, and self-hosted use cases ([compare them here](./api))
