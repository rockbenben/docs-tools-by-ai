...
:::tip Quick summary
md-translator is a free online tool purpose-built for translating technical docs while preserving Markdown structure — code blocks, LaTeX formulas, and structured metadata stay intact. It supports 100+ languages, simultaneous multi-language output, and a "Plain Text Mode" for arbitrary text, making it the go-to choice for translating open-source docs and blogs.
:::
