...
howto:
  ...
  steps:
    ...
    - name: Translate
      text: Click Translate. Code blocks, LaTeX formulas, FrontMatter metadata, and links all stay intact. For arbitrary plain text, turn on "Plain Text Mode" to skip Markdown parsing entirely.
faq:
