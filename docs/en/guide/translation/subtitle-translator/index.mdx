...
faq:
  ...
  - q: How do I proofread and revise the translation after translating? Can I edit it line by line?
    a: >-
      Two features cover this — one for editing it yourself, one for letting an AI do it. (1) Side-by-side
      Review: in single-file, translated-only export mode, after translation a panel appears below with the
      original and the translation side by side, line by line. Edit any line you don't like in the translation
      column, then click 'Apply & Download' to get the revised subtitle with timecodes preserved — ideal for
      hand-checking and fixing machine-translation mistakes without touching the timeline. (2) Extract Text +
      your own AI: 'Extract Text' exports the original dialogue with timecodes and cue numbers stripped
      (auto-copied to clipboard), while the translation is copied separately from the result card's Copy button;
      paste both the original and the translation into any AI and use your own prompt to proofread/revise the
      translation against the source — ask for a change summary too if you like. Use Review to edit it yourself,
      Extract Text plus an external AI to have it revised to your spec.
...
- **Multiple API Options**: Built-in free / commercial translation APIs plus 20+ AI LLM endpoints (including local Ollama / LM Studio / koboldcpp, and the translation-specialized TranslateGemma / MiLMMT) — pick by budget and privacy needs.
