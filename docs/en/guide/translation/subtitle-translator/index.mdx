...
description: "Free SRT/ASS/SSA/VTT/LRC/SBV batch subtitle translator with 35 engines: DeepSeek, Claude, GPT, DeepL, Google. 120+ languages, preserved timecodes, bilingual output."
...
howto:
  ...
  steps:
    - name: Upload your subtitle file
      text: Drag or paste a .srt / .ass / .ssa / .vtt / .lrc / .sbv file into the main view.
...
faq:
  - q: Which subtitle formats are supported? Can it translate SRT, ASS, VTT, and LRC?
    a: >-
      Six formats supported: SRT, ASS, SSA, VTT, LRC, and SBV. SRT/VTT fit YouTube, HTML5 players, and creator dashboards
      (export YouTube captions with yt-dlp); ASS/SSA fit Aegisub and anime fansubs, with line-leading position tags
      (e.g. \an8) auto-restored after translation; LRC fits music lyrics; SBV is what YouTube's caption editor exports. File encoding
  ...
  - q: Should I use machine translation or an AI/LLM for subtitles? Which is best quality, which is cheapest?
    a: >-
      ...
      noticeably more natural — DeepSeek is the value pick for whole-season batches; Claude Sonnet 5 or GPT-5.6 give
      the most natural dialogue; Gemini 3.1 Pro's long context handles book-length subtitles. Engine configs
...
:::tip Quick summary
Subtitle Translator is a free online batch subtitle translator supporting SRT, ASS, SSA, VTT, LRC, and SBV formats across 120+ languages. Block-compression plus parallel translation finishes a full TV episode in ~1 second. It also offers context-aware translation, a live line-by-line result stream, local cache reuse, and 9 free / commercial translation APIs plus 26 LLM endpoints (including local Ollama / LM Studio / koboldcpp and the translation-specialized TranslateGemma / MiLMMT).
:::
