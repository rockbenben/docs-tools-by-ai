...
:::tip Quick summary
Subtitle Translator is a free online batch subtitle translator supporting SRT, ASS, VTT, and LRC formats across 100+ languages. Block-compression plus parallel translation finishes a full TV episode in ~1 second. It also offers context-aware translation, local cache reuse, and 3 free + 3 commercial + 5 AI LLM interfaces.
:::
...
- **Multi-language Support & Internationalization**: Supports 100+ major languages (English, Chinese, Japanese, Korean, French, German, Spanish, etc.) and can translate the same subtitle file into multiple languages simultaneously to meet internationalization needs.
