...
head:
  - - meta
    - property: og:title
      content: Supported Languages List - 50+ Languages for Translation | Tools By AI
description: Wondering which languages our tools support? Here is a detailed list of over 50 languages, including English, Chinese, Japanese, and more, with official docs from DeepL and Google.
---
