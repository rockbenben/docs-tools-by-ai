...
head:
  - - meta
    - property: og:title
      content: Supported Languages - 100+ Languages | Tools By AI
description: Complete language code reference table with 100+ supported languages, grouped by region. Includes language codes, native names, English names, and Chinese names for batch multi-language configuration.
---

# Language Support

This tool supports translation between 100+ major languages, organized by region.
...
- [Qwen-MT supported languages](https://help.aliyun.com/zh/model-studio/translation-abilities)
