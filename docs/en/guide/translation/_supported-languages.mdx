...
head:
  - - meta
    - property: og:title
      content: Supported Languages - 120+ Languages | Tools By AI
description: Complete language code reference table with 120+ supported languages, grouped by region. Includes language codes, native names, English names, and Chinese names for batch multi-language configuration.
---
...
- [Google Translate supported languages](https://docs.cloud.google.com/translate/docs/languages)
- [Azure Translator supported languages](https://learn.microsoft.com/azure/ai-services/translator/language-support)
- [Qwen-MT supported languages](https://help.aliyun.com/zh/model-studio/machine-translation#14735a54e0rwb)
