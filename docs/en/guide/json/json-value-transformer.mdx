...
faq:
  ...
  - q: Will processing large JSON files be slow?
    a: >-
      For extremely large JSON, drop the file into the upload area instead of pasting it.
      All processing runs in your browser — files never leave your machine. Deeply nested
