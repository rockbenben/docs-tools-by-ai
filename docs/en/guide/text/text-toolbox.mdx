...
howto:
  ...
  steps:
    ...
    - name: Pick and stack rules
      text: From the Regex Engine, Filter/Sort, and Batch Rewrite panels, toggle the operations you want — regex match, dedupe, filter, batch prefix/suffix, URL extract are all stackable.
