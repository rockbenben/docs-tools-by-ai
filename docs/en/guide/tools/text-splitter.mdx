...
howto:
  ...
  steps:
    ...
    - name: Pick a splitting mode
      text: Fixed-size chunks (for AI input) → By Length; long Chinese text by paragraph → Chinese Paragraph; English text by sentence → English Paragraph.
    - name: Configure delimiters (optional)
      text: To align cuts to delimiters like `. ? !`, fill in the delimiter field.
